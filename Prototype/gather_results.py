...
def extract_result(dir_name):
    try:
        ...
        print("[Warning] no file {} found!".format(dir_name))
        return 1000
...
error_threshold = float(input("Enter fasibility threshold (All tests that have a lower error will be considered as accepted): "))
